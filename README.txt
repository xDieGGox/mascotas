...
a persistence unit "mascotasPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "mascotas/pom.xml":
...
artifact ("mascotas.war") is already built. You can build
